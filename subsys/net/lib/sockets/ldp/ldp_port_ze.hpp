...
struct mcb_dummy : public mcb_if
{
  ...
  virtual void switch_role(uint8_t role) {}
  ...
  virtual uint8_t *get_rx_buf(uint8_t port) { return dummy_buf; }
  virtual uint8_t *get_tx_buf(uint8_t port) { return dummy_buf; }
  virtual uint16_t get_rx_len(uint8_t port) { return 0; }
  virtual uint16_t get_tx_len(uint8_t port) { return 0; }
  ...
  virtual bool has_rx(uint8_t port) { return false; }
  virtual void clr_rx(uint8_t port) {}
  virtual uint8_t get_sid() { return 0; }
private:
