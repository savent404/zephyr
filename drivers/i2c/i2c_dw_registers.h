...
#define DW_IC_INTR_STAT_STOP_DET_BIT (9)
DEFINE_TEST_BIT_OP(intr_stat_tx_abrt, DW_IC_REG_INTR_STAT, DW_IC_INTR_STAT_TX_ABRT_BIT)
DEFINE_TEST_BIT_OP(intr_stat_stop_det, DW_IC_REG_INTR_STAT, DW_IC_INTR_STAT_STOP_DET_BIT)
...
#define DW_IC_STATUS_TFE_BIT      (2)
#define DW_IC_STATUS_RFNE_BIT     (3)
#define DW_IC_STATUS_RFF_BIT      (4)
#define DW_IC_STATUS_MA_BIT       (5)
#define DW_IC_STATUS_SA_BIT       (6)
...
DEFINE_TEST_BIT_OP(status_tfe, DW_IC_REG_STATUS, DW_IC_STATUS_TFE_BIT)
DEFINE_TEST_BIT_OP(status_rfne, DW_IC_REG_STATUS, DW_IC_STATUS_RFNE_BIT)
DEFINE_TEST_BIT_OP(status_rff, DW_IC_REG_STATUS, DW_IC_STATUS_RFF_BIT)
DEFINE_TEST_BIT_OP(status_ma, DW_IC_REG_STATUS, DW_IC_STATUS_MA_BIT)
DEFINE_TEST_BIT_OP(status_sa, DW_IC_REG_STATUS, DW_IC_STATUS_SA_BIT)
