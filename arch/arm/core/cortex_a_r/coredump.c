 ...
 * Copyright (c) 2026 ARMv7-A Cortex-A Adaptation.
 *
...
#warning "coredump won't restore FPU/VFP context"
#endif
...
void arch_coredump_info_dump(const struct arch_esf *esf)
{
...
#if defined(CONFIG_FPU) || defined(CONFIG_CPU_HAS_VFP)
	printk("WARNING: coredump does not include FPU/VFP context\n");
#endif
	...
	arch_blk.r.cpsr = esf->basic.xpsr;
...
{
	return COREDUMP_TGT_ARM_CORTEX_A;
}
